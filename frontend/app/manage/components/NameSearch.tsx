...
export default function NameSearch() {
  ...
  const checkNameAvailability = async () => {
    ...
    try {
      // Normalize the domain name (without .rsk for checking availability)
      ...
      // Get the FIFS registrar address from BulkManager
      ...
      if (available) {
        ...
        // Domain is not available, let's try to get owner info
        try {
          ...
          // Couldn't get owner but registrar says not available
          setSearchResult({
            available: false,
            registered: true,
          });
