  ...
  return (
    <div className="px-8 py-12">
      <div className="max-w-5xl">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-4">Update Domain Settings</h1>
          <p className="text-gray-400 text-lg">
            Select domains to update their addresses or resolvers in bulk
          </p>
        </div>
        ...
        <div className="space-y-8">
          ...
          {!isLoading && domains.length === 0 && (
            <div className="bg-gray-900 rounded-lg p-12 border border-gray-700 text-center">
              <p className="text-gray-400 text-lg">
                No domains found. Select domains from "My Domains" tab to update them here.
              </p>
            </div>
          )}
        </div>
